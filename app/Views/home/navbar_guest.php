        ...
        <div class="collapse navbar-collapse justify-content-between phone-vh-100 hide-scroll-bar" id="navbar-menu">
            ...
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item py-3 px-2 sm-d-none position-relative">
                    <a href="index.php?page=signin" type="button" class="p-0 px-3 btn rounded-5 border-opacity-25 border-light d-flex align-items-center nav-btn" style="width: fit-content;">
                        <i class="bi bi-person-circle text-orange d-flex justify-content-center align-items-center pe-2 fs-5"></i>
                        <span class="text-orange fs-5">Sign in</span>
                    </a>
                </li>
            </ul>
        </div>
